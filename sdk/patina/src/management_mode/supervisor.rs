...
///   `R9` = `arg3`.
/// - The supervisor returns its result in `RAX`.
///
/// ## Safety
///
...
/// other target this is a stub returning `0`.
...
///
/// Supervisor syscalls only run in Ring 3 user MM on x86-64; off-target there is
/// no supervisor, so this returns `0`.
///
/// ## Safety
///
