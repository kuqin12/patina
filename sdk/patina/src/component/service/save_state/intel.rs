...
// ============================================================================
// IOMisc Bit Definitions (Intel-specific)
// ============================================================================

/// IOMisc Type field value: OUT instruction.
const IOMISC_TYPE_OUT: u32 = 0;
/// IOMisc Type field value: IN instruction.
const IOMISC_TYPE_IN: u32 = 1;
...
pub fn register_info(reg: MmSaveStateRegister) -> Option<RegisterInfo> {
    match reg {
        // Descriptor table bases (split hi/lo dwords — non-contiguous on Intel)
...
// ============================================================================
// I/O Field Parsing (Intel IOMisc)
// ============================================================================
...
pub fn parse_io_field(io_field: u32) -> Option<ParsedIoInfo> {
    ...
    let io_type = match io_type_raw {
        IOMISC_TYPE_OUT => IO_TYPE_OUTPUT,
        IOMISC_TYPE_IN => IO_TYPE_INPUT,
        _ => return None,
    };
...
mod tests {
    ...
    fn test_parse_io_field_out() {
        ...
        let io_field: u32 = (0x0CF8 << 16) | (0 << 4) | (4 << 1) | 1;
        let parsed = parse_io_field(io_field).unwrap();
    ...
    fn test_parse_io_field_no_smi_flag() {
        ...
        let io_field: u32 = (0x0080 << 16) | (1 << 4) | (1 << 1) | 0;
